...
<html>
		...
		<script language="javascript">
			...
			function val_form(){
				...
				if(bValid){
					...
					var ret;
				//	$.getJSON("userCheck", { "user.name": name.val(), "user.passwd": password.val() },
				//		 function(data){
				//		   ret = data['success'];
				//		   });
					$.ajax({
						  type: "POST",
						  url: "userCheck",
						  data: { "user.name": name.val(), "user.passwd": password.val()},
	...
	<body>
			...
			<div id="main">
				<div id="left">
					<img src="images/dkq.jpg" width="420" height = "251">
				</div>
				<div id="right">
				<form action="login" method="post" id="login_form" onsubmit="return val_form()">
					<dl>
					<dd id="valtip"><div class="validateTips"></div><img id="waitImg" src="images/wait.gif" /></dd>
						...
						<dd>
							<input type="password" id="pwd" name="user.passwd" tabindex="2" />
						</dd> 
						<dd>
