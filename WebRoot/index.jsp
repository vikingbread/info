         ...
         <div id="header">
             <div id="logo">
               ...
               <div id="rightMenu">
                 ...
                 <div class="right">
                     <ul>
                    <li><a title="修改密码" target="rightFrame" href="changePW0?user.name=${sessionScope.user.name }"><img src="images/pass.gif"/></a> </li>
                         <li><a title="用户信息" target="rightFrame" href="http://localhost:8080/info/queryUserById?user.id=${sessionScope.user.id }"><img src="images/user.gif"/></a> </li>
                         <li><a title="退出系统" href="logout"><img src="images/quit.gif"/></a> </li>
                     </ul>
                 </div>
               </div>
             </div>
